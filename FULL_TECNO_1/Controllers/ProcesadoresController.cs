...
namespace FULL_TECNO_1.Controllers
{
    public class ProcesadoresController : Controller
    {
        ...
        public ProcesadoresController(FULL_TECNO_1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,ReleaseDate,Price")] Procesadores procesadores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,ReleaseDate,Price")] Procesadores procesadores)
        {

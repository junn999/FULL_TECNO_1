...
namespace FULL_TECNO_1.Controllers
{
    ...
    {
        private readonly FULL_TECNO_1Context _context;

        public TarjetasGraficasController(FULL_TECNO_1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,ReleaseDate,Price")] TarjetasGraficas tarjetasGraficas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,ReleaseDate,Price")] TarjetasGraficas tarjetasGraficas)
        {

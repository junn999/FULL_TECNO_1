...
namespace FULL_TECNO_1.Controllers
{
    public class MonitoresController : Controller
    {
        ...
        public MonitoresController(FULL_TECNO_1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,ReleaseDate,Price")] Monitores monitores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,ReleaseDate,Price")] Monitores monitores)
        {
            if (id != monitores.Id)
            {
                return NotFound();

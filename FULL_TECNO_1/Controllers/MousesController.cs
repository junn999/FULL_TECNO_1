...
namespace FULL_TECNO_1.Controllers
{
    public class MousesController : Controller
    {
        ...
        public MousesController(FULL_TECNO_1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,ReleaseDate,Price")] Mouses mouses)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,ReleaseDate,Price")] Mouses mouses)
        {
            if (id != mouses.Id)
            {
                return NotFound();

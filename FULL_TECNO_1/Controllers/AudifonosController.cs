...
namespace FULL_TECNO_1.Controllers
{
    public class AudifonosController : Controller
    {
        ...
        public AudifonosController(FULL_TECNO_1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,ReleaseDate,Price")] Audifonos audifonos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,ReleaseDate,Price")] Audifonos audifonos)
        {
            if (id != audifonos.Id)
            {
                return NotFound();
